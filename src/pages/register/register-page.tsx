        ...
        <div className="register-page">
            <div className="register-container">
                ...
                <div className="register-header">
                    ...
                    <p className="register-subtitle">Join AnalyzePoint to start analyzing customer feedback with AI</p>
                </div>
                ...
                <p className="terms-text">
                    By clicking 'Create account' or continuing, you agree to AnalyzePoint's{" "}
